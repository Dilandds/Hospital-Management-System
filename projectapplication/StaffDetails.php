...
$table="";
     ...
     $query="SELECT First_Name,Last_Name,Age,Mobile_No,Gender,Address,Staff_Id
             FROM staff
...
<div> 
<label for="Staff Id"><b>Staff ID:</b></label>

<input type="text" placeholder="Enter StaffID" name="StaffId">
